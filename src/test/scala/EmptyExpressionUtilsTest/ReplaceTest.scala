...
class ReplaceTest extends AnyFlatSpec with Matchers:
  ...
  "In ((a ∧ ¬b) ∨ c) the subexp ¬b" should "be replaced with X0" in {
    ...
    val expected: EmptyExpression = Or(And(Symbol(EmptyVariable("a")), Symbol(EmptyVariable("X0"))), Symbol(EmptyVariable("c")))
    val result = replace(exp, substitution, Symbol(EmptyVariable("X0")))
    println(result)
  ...
  "In ((a ∧ ¬b) ∨ c) the subexp ((a ∧ ¬b) ∨ c)" should "be replaced with X0" in {
    val exp: EmptyExpression = Or(And(Symbol(EmptyVariable("a")), Not(Symbol(EmptyVariable("b")))), Symbol(EmptyVariable("c")))
    val substitution: EmptyExpression = Or(And(Symbol(EmptyVariable("a")), Not(Symbol(EmptyVariable("b")))), Symbol(EmptyVariable("c")))
  ...
  "In ((¬b ∧ ¬b) ∨ ¬b) the subexp ¬b" should "be replaced with X0" in {
    val exp: EmptyExpression = Or(And(Not(Symbol(EmptyVariable("b"))), Not(Symbol(EmptyVariable("b")))), Not(Symbol(EmptyVariable("b"))))
    val substitution: EmptyExpression = Not(Symbol(EmptyVariable("b")))
    val expected: EmptyExpression = Or(And(Symbol(EmptyVariable("X0")), Symbol(EmptyVariable("X0"))), Symbol(EmptyVariable("X0")))
    val result = replace(exp, substitution, Symbol(EmptyVariable("X0")))
    result shouldBe expected
  }

  "In ((a ∧ ¬b) ∨ c) the subexp ¬b" should "be replaced with X0 and then in ((a ∧ X0) ∨ c) the subexp (a ∧ X0) with X1" in {
    val expression: EmptyExpression = Or(And(Symbol(EmptyVariable("a")), Not(Symbol(EmptyVariable("b")))), Symbol(EmptyVariable("c")))
    val sub1: EmptyExpression = Not(Symbol(EmptyVariable("b")))
    val exp1: EmptyExpression = Or(And(Symbol(EmptyVariable("a")), Symbol(EmptyVariable("X0"))), Symbol(EmptyVariable("c")))
  ...
  "In ((a ∧ ¬b) ∨ ¬b) the subexp ¬b" should "be replaced with X0" in {
    val exp: EmptyExpression = Or(And(Symbol(EmptyVariable("a")), Not(Symbol(EmptyVariable("b")))), Not(Symbol(EmptyVariable("b"))))
    val substitution: EmptyExpression = Not(Symbol(EmptyVariable("b")))
    val expected: EmptyExpression = Or(And(Symbol(EmptyVariable("a")), Symbol(EmptyVariable("X0"))), Symbol(EmptyVariable("X0")))
    val result = replace(exp, substitution, Symbol(EmptyVariable("X0")))
    result shouldBe expected
  }
